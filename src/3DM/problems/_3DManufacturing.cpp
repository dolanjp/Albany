...
//Constructor for 3DM
Albany::_3DManufacturing::
_3DManufacturing(const Teuchos::RCP<Teuchos::ParameterList>& params_,
...
{
  ConstructEvaluatorsOp<_3DManufacturing> op(
...
// Dirichlet BCs
void Albany::_3DManufacturing::constructDirichletEvaluators(
...
// Neumann BCs
void Albany::_3DManufacturing::constructNeumannEvaluators(
...
Albany::_3DManufacturing::getValidProblemParameters() const
{
  Teuchos::RCP<Teuchos::ParameterList> validPL =
    this->getGenericProblemParams("Valid_3DManufacturingParams");
